            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8 mb-10" method="POST"
                            ...
                            <div class="xl:w-96 w-80 sm:w-40">
                                ...
                                <select name="customer_id"
                                    ...
                                    @foreach($customers as $customer)
                                        <option
                                            value="{{ $customer->id }}">{{ $customer->display_name }}</option>
                                    @endforeach
                                </select>
                                    ...
                                    <table class="min-w-full border text-center" id="customFields">
                                        ...
                                        <tr class="border-b item">
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap"
                                                style="border-right-style: hidden;" id="remCF">
                                                <div class="flex items-center">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="1.5" stroke="#F00"
                                                         class="w-6 h-6 ml-3 -mr-5 hover:cursor-pointer">
                    ...
                    <div class="grid grid-cols-2">
                        <div
                            class="flex align-middle items-center bg-slate-100 w-1/3 p-4 hover:cursor-pointer rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#408dfb"
                                 class="w-6 h-6 mr-2">
