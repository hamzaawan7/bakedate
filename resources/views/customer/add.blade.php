            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8 mb-10" method="POST"
                    ...
                    <div class="flex flex-wrap align-middle">
                        ...
                        <div class="form-check form-check-inline ml-5">
                            <input
                                ...
                                id="individual"
                                value="individual">
                            <label class="form-check-label inline-block text-gray-800" for="individual">Individual</label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="company_name" type="text" class="form-input w-full @error('company_name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="address" type="text" class="form-input w-full"
                               name="address">
